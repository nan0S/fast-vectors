...
template<>
inline constexpr bool is_trivially_default_constructible_v<T_test_type> = true;
template<>
inline constexpr bool is_trivially_copy_constructible_v<T_test_type> = true;
template<>
inline constexpr bool is_trivially_move_constructible_v<T_test_type> = true;
template<>
inline constexpr bool is_trivially_copy_assignable_v<T_test_type> = true;
template<>
inline constexpr bool is_trivially_move_assignable_v<T_test_type> = true;
template<>
inline constexpr bool is_trivially_destructible_v<T_test_type> = true;
template<>
inline constexpr bool is_trivially_relocatable_v<T_test_type> = true;
